(function () {
  ...
  */
  var TRACKS = [
    ...
    { title: "BIRDS OF A FEATHER", artist: "Billie Eilish", src: "music/Billie Eilish - BIRDS OF A FEATHER.mp3", cover: "♾️" },
    { title: "Best Part", artist: "Daniel Caesar/H.E.R.", src: "music/Daniel Caesar; H.E.R. - Best Part.mp3", cover: "♾️" },
    { title: "Oblivion", artist: "Grimes", src: "music/Grimes - Oblivion.mp3", cover: "♾️" },
    { title: "Butterfly", artist: "Grimes", src: "music/Grimes - Butterfly.mp3", cover: "🦋" },
    { title: "Genesis", artist: "Grimes", src: "music/Grimes - Genesis.mp3", cover: "🧬" },
    { title: "Realiti", artist: "Grimes", src: "music/Grimes - Realiti.mp3", cover: "🫧" },
    { title: "Hammer", artist: "Lorde", src: "music/Lorde - Hammer.mp3", cover: "🔨" },
    { title: "Green Light", artist: "Lorde", src: "music/Lorde - Green Light.mp3", cover: "💚" },
    ...
    { title: "Running Up That Hill (A Deal With God)", artist: "Kate Bush", src: "music/Kate Bush - Running Up That Hill (A Deal With God).mp3", cover: "💿" },
